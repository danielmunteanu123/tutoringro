...
public class AdapterSedinteProfesor extends RecyclerView.Adapter<AdapterSedinteProfesor.ViewHolder>{
    ...
    public AdapterSedinteProfesor(ArrayList<ManagerStudenti> studenti) {
