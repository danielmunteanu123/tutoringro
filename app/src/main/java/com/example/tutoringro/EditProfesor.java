...
public class EditProfesor extends AppCompatActivity {
    ...
    private void showAllUserData() {
             ...
             _EMAIL = profesor.getEmail();
             _TELEFON = profesor.getTelefon();
             _PAROLA = profesor.getParola();
             _CATEGORII = profesor.getCategorii();
             _SUBCATEGORII = profesor.getSubcategorii();
             _MATERII = profesor.getMaterii();
             _DISTANTA = String.valueOf(profesor.getDistanta());
             _DOMICILIU = profesor.getDomiciliu();
             _PRET = String.valueOf(profesor.getPret());
             _JUDET = profesor.getJudet();
    ...
    private boolean schimbaEmail() {
        ...
        private Boolean validateDomiciliu () {
            ...
            if (!matcher.matches()) {
                domiciliu.setError("Adresa nu poate conține caractere speciale.");
                return false;
            }
            ...
            if (val.isEmpty()) {
                ...
                return false;
                    ...
                    domiciliu.setError("Adresă prea mică.");
                    return false;
                }else {
        ...
        private Boolean validateNume () {
            ...
            if (!matcher.matches()) {
                nume.setError("Format incorect. (Exemplu: Mihai Munteanu)");
                return false;
            }
    ...
    public void onBackPressed() {
        new AlertDialog.Builder(this)
                .setMessage("Sunteti sigur? Toate datele pe care nu le-ați salvat vor fi pierdute.")
                .setCancelable(false)
                .setPositiveButton("Confirma", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        EditProfesor.super.onBackPressed();
