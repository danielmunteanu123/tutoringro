...
public class EditStudent extends AppCompatActivity {
    ...
    private void showAllUserData() {
        ...
        _EMAIL = student.getEmail();
        _TELEFON = student.getTelefon();
        _PAROLA = student.getParola();
        _CATEGORII = student.getCategorii();
        _SUBCATEGORII = student.getSubcategorii();
        _MATERII = student.getMaterii();
        _VARSTA = String.valueOf(student.getVarsta());
        _DOMICILIU = student.getDomiciliu();
        _JUDET = student.getJudet();
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Da", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        EditStudent.super.onBackPressed();
