...
public class AdapterProfesori extends RecyclerView.Adapter<AdapterProfesori.ViewHolder>{
    ...
    public AdapterProfesori(ArrayList<ManagerProfesori> profesori) {
